...
module.exports = {
 ...
 category: 'Filters',
 cooldown: 5,
 description: 'Toggle rock audio filter',
 args: false,
 usage: '',
 userPrams: [],
 botPrams: ['EmbedLinks'],
   ...
   try {
     ...
     if (player.rock) {
       ...
       const disabledEmbed = new EmbedBuilder()
         ...
         .setDescription('🎸 | Rock filter has been **disabled**')
         .addFields(
           { 
             name: 'Now Playing', 
       ...
       const enabledEmbed = new EmbedBuilder()
         ...
         .setDescription('🎸 | Rock filter has been **enabled**')
         .addFields(
           { 
             name: 'Now Playing', 
             value: player.queue.current?.title || 'Unknown',
     ...
     console.error('Rock filter error:', error);
     
     const errorEmbed = new EmbedBuilder()
       .setColor('#ff0000')
       .setDescription('❌ | An error occurred while toggling the rock filter.')
       .setTimestamp();
